/** @namespace live.bilibili */

/**
 * @typedef {Object} live.bilibili.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} live.bilibili.HTTPCallback
...
/**
 * @typedef {function(Object, live.bilibili.HTTPCallback): live.bilibili.HTTPResponse} live.bilibili.HTTPMethod
 */

/**
 * @typedef {Object} live.bilibili.HttpClient
 * @property {live.bilibili.HTTPMethod} get - 发送 GET 请求
 * @property {live.bilibili.HTTPMethod} post - 发送 POST 请求
 * @property {live.bilibili.HTTPMethod} put - 发送 PUT 请求
 * @property {live.bilibili.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {live.bilibili.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<live.bilibili.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {live.bilibili.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<live.bilibili.HTTPResponse>}
 */
