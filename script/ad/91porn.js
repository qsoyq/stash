...
/**
 * @typedef {Object} porn91.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} porn91.HTTPCallback
...
/**
 * @typedef {function(Object, porn91.HTTPCallback): porn91.HTTPResponse} porn91.HTTPMethod
 */

/**
 * @typedef {Object} porn91.HttpClient
 * @property {porn91.HTTPMethod} get - 发送 GET 请求
 * @property {porn91.HTTPMethod} post - 发送 POST 请求
 * @property {porn91.HTTPMethod} put - 发送 PUT 请求
 * @property {porn91.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {porn91.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<porn91.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {porn91.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<porn91.HTTPResponse>}
 */
...
function addCSS(document) {
    ...
    .thumb-overlay {
        height: unset; // 重写后，首页略缩图和父元素高度不匹配
    }
...
function runtime(document) {
    ...
    if (url.pathname === '/view_video.php') {
        addScript(document, "https://raw.githubusercontent.com/qsoyq/shell/main/tampermonkey/91/shortcuts.js")
    }
    addCSS(document)
}
