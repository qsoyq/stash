...
/**
 * @typedef {Object} telegram.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} telegram.HTTPCallback
...
/**
 * @typedef {function(Object, telegram.HTTPCallback): telegram.HTTPResponse} telegram.HTTPMethod
 */

/**
 * @typedef {Object} telegram.HttpClient
 * @property {telegram.HTTPMethod} get - 发送 GET 请求
 * @property {telegram.HTTPMethod} post - 发送 POST 请求
 * @property {telegram.HTTPMethod} put - 发送 PUT 请求
 * @property {telegram.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {telegram.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<telegram.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {telegram.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<telegram.HTTPResponse>}
 */
...
function runtime(document) {
    Array.from(document.querySelectorAll("script")).forEach(ele => {
        if (ele.textContent.includes("protoUrl")) {
            ele.textContent = `${injectionFunc}`
        }
    })
