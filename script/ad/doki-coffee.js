...
/**
 * @typedef {Object} doki.coffeeHTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} doki.coffeeHTTPCallback
...
/**
 * @typedef {function(Object, doki.coffeeHTTPCallback): doki.coffeeHTTPResponse} doki.coffeeHTTPMethod
 */

/**
 * @typedef {Object} doki.coffeeHttpClient
 * @property {doki.coffeeHTTPMethod} get - 发送 GET 请求
 * @property {doki.coffeeHTTPMethod} post - 发送 POST 请求
 * @property {doki.coffeeHTTPMethod} put - 发送 PUT 请求
 * @property {doki.coffeeHTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {doki.coffeeHttpClient} */
var $httpClient;
 ...
 * @returns {Promise<doki.coffeeHTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {doki.coffeeHTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<doki.coffeeHTTPResponse>}
 */
...
async function main() {
    ...
    switch (getScriptType()) {
        case "response":
            ...
            let realBody = JSON.parse(body.data)
            realBody["INDEXTOPPOPUP"] = []
            body["data"] = JSON.stringify(realBody)
