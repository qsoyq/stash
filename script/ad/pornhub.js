...
/**
 * @typedef {Object} pornhub.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} pornhub.HTTPCallback
...
/**
 * @typedef {function(Object, pornhub.HTTPCallback): pornhub.HTTPResponse} pornhub.HTTPMethod
 */

/**
 * @typedef {Object} pornhub.HttpClient
 * @property {pornhub.HTTPMethod} get - 发送 GET 请求
 * @property {pornhub.HTTPMethod} post - 发送 POST 请求
 * @property {pornhub.HTTPMethod} put - 发送 PUT 请求
 * @property {pornhub.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {pornhub.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<pornhub.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {pornhub.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<pornhub.HTTPResponse>}
 */
...
function removeAdsCode() {
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        console.log(document.querySelectorAll('[class="alpha"]'))
        Array.from(document.querySelectorAll('[class="alpha"]')).forEach(e => { e.remove() })
        Array.from(document.querySelectorAll('span')).forEach(e => {
            if (e.textContent === "Ad By Traff") {
                console.log(e)
                // @ts-ignore
