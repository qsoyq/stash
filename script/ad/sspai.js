...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} sspai.HTTPCallback
...
/**
 * @typedef {function(Object, sspai.HTTPCallback): sspai.HTTPResponse} sspai.HTTPMethod
 */

/**
 * @typedef {Object} sspai.HttpClient
 * @property {sspai.HTTPMethod} get - 发送 GET 请求
 * @property {sspai.HTTPMethod} post - 发送 POST 请求
 * @property {sspai.HTTPMethod} put - 发送 PUT 请求
 * @property {sspai.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {sspai.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<sspai.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {sspai.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<sspai.HTTPResponse>}
 */
