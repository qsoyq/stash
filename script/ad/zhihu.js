...
/**
 * @typedef {Object} zhihu.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} zhihu.HTTPCallback
...
/**
 * @typedef {function(Object, zhihu.HTTPCallback): zhihu.HTTPResponse} zhihu.HTTPMethod
 */

/**
 * @typedef {Object} zhihu.HttpClient
 * @property {zhihu.HTTPMethod} get - 发送 GET 请求
 * @property {zhihu.HTTPMethod} post - 发送 POST 请求
 * @property {zhihu.HTTPMethod} put - 发送 PUT 请求
 * @property {zhihu.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {zhihu.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<zhihu.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {zhihu.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<zhihu.HTTPResponse>}
 */
