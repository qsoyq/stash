...
/**
 * @typedef {Object} nodeseek.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} nodeseek.HTTPCallback
...
/**
 * @typedef {function(Object, nodeseek.HTTPCallback): nodeseek.HTTPResponse} nodeseek.HTTPMethod
 */

/**
 * @typedef {Object} nodeseek.HttpClient
 * @property {nodeseek.HTTPMethod} get - 发送 GET 请求
 * @property {nodeseek.HTTPMethod} post - 发送 POST 请求
 * @property {nodeseek.HTTPMethod} put - 发送 PUT 请求
 * @property {nodeseek.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {nodeseek.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<nodeseek.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {nodeseek.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<nodeseek.HTTPResponse>}
 */
