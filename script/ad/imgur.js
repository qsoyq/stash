...
/**
 * @typedef {Object} imgur.HTTPResponse
...
/**
 * @typedef {function(Error|string|null, Object, string|null): void} imgur.HTTPCallback
...
/**
 * @typedef {function(Object, imgur.HTTPCallback): imgur.HTTPResponse} imgur.HTTPMethod
 */

/**
 * @typedef {Object} imgur.HttpClient
 * @property {imgur.HTTPMethod} get - 发送 GET 请求
 * @property {imgur.HTTPMethod} post - 发送 POST 请求
 * @property {imgur.HTTPMethod} put - 发送 PUT 请求
 * @property {imgur.HTTPMethod} delete - 发送 DELETE 请求
 */

/** @type {imgur.HttpClient} */
var $httpClient;
 ...
 * @returns {Promise<imgur.HTTPResponse>} 返回一个 Promise，解析为包含 error、response 和 data 的对象
 * @throws {Error} 如果请求失败，Promise 会被拒绝并返回错误信息
 */
async function request(method, params) {
    return new Promise((resolve, reject) => {
        /** @type {imgur.HTTPMethod} */
 ...
 * 请求封装
 * @param {object} params
 * @returns {Promise<imgur.HTTPResponse>}
 */
